...
export default function Breadcrumbs() {
  ...
  return (
    <div className="border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-[#1e1f20] px-6 py-2.5 flex items-center justify-between gap-4 flex-wrap">
      ...
      {selectedItem ? (
        <div className="flex items-center gap-1.5 bg-slate-100 dark:bg-[#282a2c] p-1 rounded-xl border border-slate-200 dark:border-slate-700 animate-in fade-in zoom-in-95 duration-100">
          <span className="text-xs font-semibold px-2.5 text-slate-600 dark:text-slate-300 truncate max-w-[150px]">
            {selectedItem.name}
          </span>
          ...
          {!selectedItem.isFolder && (
            <button
              ...
              className="p-1.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-white dark:hover:bg-[#37393b] hover:text-blue-500 transition-colors"
              title="Preview / Play"
            >
          ...
          {!selectedItem.isFolder && (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="p-1.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-white dark:hover:bg-[#37393b] hover:text-blue-500 transition-colors inline-flex"
              title="Download"
            >
          ...
          <button
            ...
            className="p-1.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-white dark:hover:bg-[#37393b] hover:text-amber-500 transition-colors"
          ...
          {section === "trash" ? (
            <>
              <button
                ...
                className="p-1.5 rounded-lg text-emerald-600 hover:bg-white dark:hover:bg-[#37393b] transition-colors"
                title="Restore"
              >
              ...
              <button
                ...
                className="p-1.5 rounded-lg text-rose-600 hover:bg-white dark:hover:bg-[#37393b] transition-colors"
            ...
            <button
              ...
              className="p-1.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-white dark:hover:bg-[#37393b] hover:text-rose-500 transition-colors"
              title="Move to Trash"
            >
              <Trash2 className="w-4 h-4" />
            </button>
