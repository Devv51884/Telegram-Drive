...
export default function BulkActionBar() {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 animate-in fade-in slide-in-from-bottom-5 duration-200">
      <div className="flex items-center gap-2 sm:gap-3 bg-slate-900/90 dark:bg-[#1e1f20]/95 backdrop-blur-xl border border-slate-700/70 shadow-2xl px-4 py-2.5 rounded-2xl text-white">
        {/* Count chip */}
