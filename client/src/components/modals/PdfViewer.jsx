  ...
  useEffect(() => {
    ...
    loadingTask.promise
      ...
      .catch((err) => {
        ...
        setError("Failed to load PDF document. You can open it in a new tab or download it directly.");
        setLoading(false);
      });
      ...
      <div className="flex-1 overflow-auto flex items-start justify-center p-3 sm:p-6 bg-slate-950/80">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center my-auto p-6 text-center text-slate-400 max-w-md">
            ...
            <h4 className="text-sm font-bold text-white mb-2">Could Not Render PDF</h4>
            <p className="text-xs mb-5 text-slate-400">{error}</p>
