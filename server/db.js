      ...
      for (const file of files) {
        await sqlite.run(
          ...
          ON CONFLICT(id) DO UPDATE SET
            ...
            telegram_file_id = COALESCE(excluded.telegram_file_id, files.telegram_file_id),
            telegram_message_id = COALESCE(excluded.telegram_message_id, files.telegram_message_id),
            telegram_channel_id = COALESCE(excluded.telegram_channel_id, files.telegram_channel_id),
            telegram_post_url = COALESCE(excluded.telegram_post_url, files.telegram_post_url),
            telegram_channel_title = COALESCE(excluded.telegram_channel_title, files.telegram_channel_title),
            telegram_access_hash = COALESCE(excluded.telegram_access_hash, files.telegram_access_hash),
            telegram_file_reference = COALESCE(excluded.telegram_file_reference, files.telegram_file_reference),
